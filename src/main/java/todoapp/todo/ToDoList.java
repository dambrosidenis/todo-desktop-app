...
class ToDoList implements Iterable<ToDo> {
     ...
     * @param toDoDescription is the description of the ToDo. At least it has to be
     *                        an empty String.
     * @param toDoTags        is the list of tags of the ToDo. At least it has to be
     *                        empty.
     * @throws EmptyFieldException  when the ToDo title is empty. In this case the
     *                              ToDo wouldn't be added.
     */
     ...
     *                              ToDo wouldn't be added.
     */
    void addToDo(String toDoTitle, String toDoDescription, String toDoCreation, Collection<String> toDoTags) throws EmptyFieldException {

        if (toDoTitle == null || toDoTitle.isEmpty() || toDoCreation.isEmpty()) {
            throw new EmptyFieldException(emptyTitleErrorString);
        }

        loadedToDos.add(new ToDo(toDoTitle, toDoDescription, toDoCreation, toDoTags));
    }
     ...
     * 
     * @param deletedToDo is the index of the instance that has to be removed.
     *                    Required a valid instance contained in loadedToDos.
     */
     ...
     * 
     * @param modifiedToDo is the index of the instance that has to be modified.
     *                     Required a valid instance contained in loadedToDos.
     * @param newTitle     is the modified title of the todo. Required a not empty
     *                     String.
     * @throws EmptyFieldException when the ToDo title is empty. In this case the
     *                             ToDo wouldn't be modified.
     */
     ...
     * 
     * @param modifiedToDo is the intex of the instance that has to be modified.
     *                     Required a valid instance contained in loadedToDos.
     * @param newTag       is the new tag of the todo.
     * @throws EmptyFieldException   when newTag is null or empty. In this case the
     *                               tag wouldn't be added.
     * @throws InvalidFieldException
     */
    void addToDoTag(int modifiedToDoIndex, String newTag) throws EmptyFieldException, InvalidFieldException {
     ...
     * 
     * @param toDoIndex is the index of the desired ToDo.
     * @return a string array containing, in order: the title, the description, the
     *         date of creation and the tags of the ToDo.
     */
    ...
    /**
     * Return an iterator interface for the list of ToDos currently active
     * 
     * @return the iterator.
     */
    @Override
    public Iterator<ToDo> iterator() {
        return loadedToDos.iterator();
    }
}   // class ToDoList
